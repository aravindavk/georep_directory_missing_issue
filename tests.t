...
USE_NODE "gserver3"
TEST "mkdir /root/.ssh"
TEST "echo '#{pub_key}' >> /root/.ssh/authorized_keys"

USE_NODE "gserver1"
TEST "gluster-georep-sshkey generate"
TEST "gluster volume geo-replication vol1 gserver3.#{network}::vol2 create push-pem"
TEST "gluster volume geo-replication vol1 gserver3.#{network}::vol2 start"
